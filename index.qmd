...
library(tidyverse)
gs4_deauth()
d <- read_sheet("https://docs.google.com/spreadsheets/d/19EDpGHJ6BqZ0TIJrviIrqlpQ3G9gF29aqek3lxblCT0/edit#gid=508065340", sheet = "sec2-elijah")
```
...
d %>%
  ...
  cols_align(
    align = "center", 
    columns = c(week, dow, prepare, slides, ae_sa, hw, hw_sa, lab, lab_sa, exam, project)
    ) %>%
  cols_align(
    align = "left", 
