...
::: callout-important
This homework is due Tuesday, Jan 31 at 11:59pm.
:::

# Getting Started

-   Go to the [sta199-s23-2](https://github.com/sta199-s23-2) organization on GitHub. Click on the repo with the prefix `hw-01`. It contains the starter documents you need to complete the homework assignment.
