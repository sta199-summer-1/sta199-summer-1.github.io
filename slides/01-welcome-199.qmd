...
Research is primarily focused on education, and how to better the teaching and learning experiences for those involved. Current research involves creating a dynamic interactive shiny application in R to better students' understanding of permutations and bootstrapping while simultaneously encouraging them to become independent coders. Other work involves identifying longitudinal breakthroughs in graduate student instructors knowledge about, emotions towards, and use of active learning. Further, the early stages have been set to help develop and instrument to measure different types of instructor's motivation towards using active learning teaching techniques in statistics.
...
-   Clone the application exercise (can be done right before class)
...
Please do so now + fill out the **getting to know you survey**
...
-- We will clone this from GitHub here: (insert link)
